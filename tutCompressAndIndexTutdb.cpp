...
#ifdef DEBUG
	dfprintf2(__LINE__,__FILE__,TUTCOMPRESSANDINDEXDBG,"in tutCompressAndIndexTutdb, initial value of uncomprLen = %lu\n",uncomprLen);
#endif
...
#ifdef DEBUG
	dfprintf2(__LINE__,__FILE__,TUTCOMPRESSANDINDEXDBG,"file offset to start of tutor file = %u\n",TotalFileSize);
#endif
...
#ifdef DEBUG
	dfprintf2(__LINE__,__FILE__,TUTCOMPRESSANDINDEXDBG,"the actual start of the tutor data records is at %u (should be %u)\n",TotalFileSize-iInitailFileOffset,sizeof(short unsigned int));
#endif
	while(1) {
...
#ifdef DEBUG
			dfprintf2(__LINE__,__FILE__,TUTCOMPRESSANDINDEXDBG,"[tutComp...]iTotRecSize = %u, index offset (rel to start of index) = %u\n",iTotRecSize,TotalIndexSize);
#endif
...
#ifdef DEBUG
		dfprintf2(__LINE__,__FILE__,TUTCOMPRESSANDINDEXDBG,"last record saved... iTotRecSize = %u, index offset (rel to start of index) = %u\n",iTotRecSize,TotalIndexSize);
#endif
		iTotRecSize = 0;
...
#ifdef DEBUG
	dfprintf2(__LINE__,__FILE__,TUTCOMPRESSANDINDEXDBG,"TotalFileSize = %lu, TotalIndexSize = %lu, iRecNumber = %i\n",TotalFileSize-iInitailFileOffset,TotalIndexSize,iRecNumber);
	dfprintf2(__LINE__,__FILE__,TUTCOMPRESSANDINDEXDBG,"calculated  TutorIndexOffset = %u\n",*TutorIndexOffset);
#endif
...
#ifdef DEBUG
	dfprintf2(__LINE__,__FILE__,TUTCOMPRESSANDINDEXDBG,"file #%i file size = %u\n",iFileNumber,(Directory+iFileNumber)->wFileSize);
#endif
...
#ifdef DEBUG
	dfprintf2(__LINE__,__FILE__,TUTCOMPRESSANDINDEXDBG,"expected uncomprLen = %u\n",uncomprLen);
#endif
...
#ifdef DEBUG
	dfprintf2(__LINE__,__FILE__,TUTCOMPRESSANDINDEXDBG,"uncomprLen after uncompress call = %lu\n",uncomprLen);
	dfprintf2(__LINE__,__FILE__,TUTCOMPRESSANDINDEXDBG,"comprLen = %lu, compresion ratio = %f\n",comprLen,(float)comprLen/(float)uncomprLen);
#endif
